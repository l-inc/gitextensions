...
namespace GitCommands
{
    ...
    public sealed class GitModule : IGitModule
    {
        ...
        public string SkipWorktreeFiles(IList<GitItemStatus> files, bool skipWorktree, out bool wereErrors)
        {
            var output = "";
            string error = "";
            wereErrors = false;
            ...
            UntrackedFilesMode untrackedFiles = UntrackedFilesMode.Default)
        {
            ...
            if (!excludeAssumeUnchangedFiles || !excludeSkipWorktreeFiles)
            {
                ...
                if (!excludeSkipWorktreeFiles)
                    result.AddRange(GitCommandHelpers.GetSkipWorktreeFilesFromString(this, lsOutput));
            }
